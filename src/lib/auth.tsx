...
export const roleNavAccess: Record<Role, NavKey[]> = {
  super_admin:                ["dashboard","my_work","projects","tasks","teams","attendance","team_attendance","leave","chat","approvals","reports","people","contacts","documents","vault","assets","founder_office","settings"],
  founder:                    ["dashboard","my_work","projects","tasks","teams","attendance","team_attendance","leave","chat","approvals","reports","people","contacts","documents","vault","assets","founder_office","settings"],
  founder_office_coordinator: ["dashboard","my_work","projects","tasks","teams","attendance","team_attendance","leave","chat","approvals","reports","people","contacts","documents","vault","assets","founder_office","settings"],
  founder_office_support:     ["dashboard","my_work","projects","tasks","teams","attendance","leave","chat","approvals","people","contacts","documents","vault","assets","founder_office"],
  ...
  hr_admin:                   ["dashboard","my_work","tasks","teams","attendance","team_attendance","leave","chat","approvals","reports","people","contacts","documents","vault","assets","settings"],
};
