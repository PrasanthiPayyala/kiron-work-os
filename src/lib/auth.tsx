...
export type NavKey =
  ...
  | "teams" | "vault" | "documents" | "assets" | "vendors" | "compliance" | "expenses" | "salary";
...
export const roleNavAccess: Record<Role, NavKey[]> = {
  super_admin:                ["dashboard","my_work","projects","tasks","teams","attendance","team_attendance","leave","expenses","salary","chat","approvals","reports","people","contacts","documents","vault","assets","vendors","compliance","founder_office","settings"],
  founder:                    ["dashboard","my_work","projects","tasks","teams","attendance","team_attendance","leave","expenses","salary","chat","approvals","reports","people","contacts","documents","vault","assets","vendors","compliance","founder_office","settings"],
  founder_office_coordinator: ["dashboard","my_work","projects","tasks","teams","attendance","team_attendance","leave","expenses","salary","chat","approvals","reports","people","contacts","documents","vault","assets","vendors","compliance","founder_office","settings"],
  ...
  hr_admin:                   ["dashboard","my_work","tasks","teams","attendance","team_attendance","leave","expenses","salary","chat","approvals","reports","people","contacts","documents","vault","assets","vendors","compliance","settings"],
};
