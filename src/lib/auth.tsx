...
export type NavKey =
  ...
  | "teams" | "vault" | "documents" | "assets" | "vendors" | "compliance" | "expenses";
...
export const roleNavAccess: Record<Role, NavKey[]> = {
  super_admin:                ["dashboard","my_work","projects","tasks","teams","attendance","team_attendance","leave","expenses","chat","approvals","reports","people","contacts","documents","vault","assets","vendors","compliance","founder_office","settings"],
  founder:                    ["dashboard","my_work","projects","tasks","teams","attendance","team_attendance","leave","expenses","chat","approvals","reports","people","contacts","documents","vault","assets","vendors","compliance","founder_office","settings"],
  founder_office_coordinator: ["dashboard","my_work","projects","tasks","teams","attendance","team_attendance","leave","expenses","chat","approvals","reports","people","contacts","documents","vault","assets","vendors","compliance","founder_office","settings"],
  founder_office_support:     ["dashboard","my_work","projects","tasks","teams","attendance","leave","expenses","chat","approvals","people","contacts","documents","vault","assets","vendors","compliance","founder_office"],
  manager:                    ["dashboard","my_work","projects","tasks","teams","attendance","leave","expenses","chat","approvals","reports","people","contacts","documents"],
  employee:                   ["dashboard","my_work","projects","tasks","teams","attendance","leave","expenses","chat","approvals","people","documents"],
  intern:                     ["dashboard","my_work","projects","tasks","teams","attendance","leave","expenses","chat","people","documents"],
  hr_admin:                   ["dashboard","my_work","tasks","teams","attendance","team_attendance","leave","expenses","chat","approvals","reports","people","contacts","documents","vault","assets","vendors","compliance","settings"],
};
